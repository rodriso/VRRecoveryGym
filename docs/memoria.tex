...
% Datos de portada
\title{VRRecoveryGym: entorno de realidad virtual para personas con problemas motrices}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 72901698R, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado <<VRRecoveryGym: entorno de realidad virtual para personas con problemas motrices>>. 
...
\begin{abstract}
puzzles, \textit {entorno virtual}, seguimiento remoto, rehabilitación motriz, Unreal Engine
\end{abstract}
