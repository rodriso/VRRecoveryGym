...
\newcommand{\nombre}{Rodrigo Grande Muñoz} %%% cambio de comando

% Datos de portada
\title{VRRecoveryGym: entorno de realidad virtual para personas con trastornos motores}
\author{\nombre}
\tutor{Álvar Arnaiz González, Héctor Royo Concepción y Luis Fuente Ibáñez}
\date{\today}
...
\noindent Que el alumno D. \nombre, con DNI 72901698R, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado <<VRRecoveryGym: entorno de realidad virtual para personas con trastornos motores>>. 
...
\begin{flushright}
	...
	\bigskip
	A mi madre y a mi padre por su esfuerzo y por creer en mí.\\
    A mi familia que entiende y acepta la ausencia.\\
    A mis amigos, que siempre han estado ahí.\\
    A Sofía, por ser un apoyo fundamental durante este bonito camino.\\
...
\begin{abstract}
El objetivo de este proyecto es desarrollar un \textit {entorno virtual} en el que los usuarios puedan realizar estos ejercicios desde casa mediante herramientas de realidad virtual. Esta solución permitirá no solo la realización remota de los ejercicios, sino también un seguimiento preciso de la actividad de cada usuario, registrando parámetros que puedan ser consultados en remoto por profesionales del sector.
...
Para el desarrollo de la aplicación se utilizará el motor Unreal Engine, empleando tanto C++ como \textit{Blueprint} para la programación de la lógica del sistema.
...
The application will be developed using the Unreal Engine, utilizing both C++ and \textit{Blueprint} for system logic programming.
...
\begin{abstract}
puzzles,  \textit {virtual environment}, remote monitoring, motor rehabilitation, Unreal Engine
\end{abstract}
